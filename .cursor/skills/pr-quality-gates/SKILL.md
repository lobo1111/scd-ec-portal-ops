...
description: Enforce PR quality gates: implementation must match the request and feature capability docs; unit tests required; deploy to dev when UI changes. Use when reviewing PRs or preparing to merge.
---
